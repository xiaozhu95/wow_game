<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:103:"D:\ruanjiananzhuang\phpstudy\PHPTutorial\WWW\wow_game\public/../application/admin\view\index\index.html";i:1584354964;s:116:"D:\ruanjiananzhuang\phpstudy\PHPTutorial\WWW\wow_game\public/../application/admin\view\template\javascript_vars.html";i:1584354964;s:109:"D:\ruanjiananzhuang\phpstudy\PHPTutorial\WWW\wow_game\public/../application/admin\view\template\nav_left.html";i:1584354964;s:109:"D:\ruanjiananzhuang\phpstudy\PHPTutorial\WWW\wow_game\public/../application/admin\view\template\nav_menu.html";i:1584354964;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li id="clear-cache"> <a href="javascript:;" title="清空缓存"><i class="Hui-iconfont" style="font-size:18px">&#xe6e2;</i></a> </li>
...
<script>
    ...
    $("#clear-cache").click(function(){
        layer.msg('清除中');
        $.get("<?php echo \think\Url::build('pub/clearCache'); ?>",{},function(data){
            if(data)
                layer.msg('清除成功');
        })
    })
